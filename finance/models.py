...
class ActiveFinanceManager(models.Manager):
    def get_queryset(self):
        return super().get_queryset().filter(is_active=True)


class Finance(models.Model):
    """Finance manager profile linked to a common User account."""
